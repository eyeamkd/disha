...
import SetPassword from "../components/Faculty/SetPassword";
    ...
    return (
      <Switch>
        ...
        <Route
          ...
          exact
          render={() =>
            !this.getCurrentUserId() ? <Redirect to="/SignIn" /> : <HomePage />
          }
        />
        <Route
          path="/SignUp"
          exact
          render={() =>
            this.getCurrentUserId() ? <Redirect to="/home" /> : <SignUp />
          }
        />
        <Route
          path="/SignIn"
          exact
          render={() =>
            this.getCurrentUserId() ? <Redirect to="/home" /> : <SignIn />
          }
        />
        <Route
          path="/community"
        ...
        <Route
          ...
          exact
          render={() =>
            !this.getCurrentUserId() ? <Redirect to="/SignIn" /> : <Profile />
          }
        />
        <Route
          path="/user-dspaces"
        ...
        <Route
          ...
          exact
          render={() =>
            !this.getCurrentUserId() ? <Redirect to="/SignIn" /> : <NewPost />
          }
        />
        <Route
          path="/data-updated"
...
function NoMatch() {
  console.log("LMAO, what are you trying to do?");
  return (
    <div
      style={{
        position: "absolute",
