...
class SignUp extends React.Component {
    ...
    handlePasswordChange = value => {
        ...
        this.setState({ password: value, passwordMessage: strength[pwdAnalysis.score] })
    };
    ...
    handleAckChange = () => {
        if (this.state.isAckChecked) {
            this.setState({ ackMessage: "* Please confirm if the details are correct" })
        }
    ...
    rollNumberExists = async (rollNumber) => {
        ...
        let query = await usersRef.where('rollNumber', '==', rollNumber).get()
            .then(snapshot => {
                if (snapshot.empty) {
                    return false;
                } else {
    ...
    isOptionDisabled = (value) => {
        switch (value) {
            ...
            case "c":
            case "d":
                return this.state.department === "IT" || this.state.department === "Civil" || this.state.department === "EEE" || this.state.department === "Mech"
    ...
    handleSignupClick = async (values, setSubmitting) => {
        ...
        try {
            const information = await auth.createUserWithEmailAndPassword(values.email, values.password)
            ...
            await createUserProfileDocument(user, { firstName, lastName, email, rollNumber, year, department, section, isAlumni, isAuthenticated, likedPosts, dspaces });
                ...
                <div className="paper">
                    ...
                    <Formik
                        ...
                        validate={values => {
                            ...
                            let department = this.setDepartmentWithRollNumber(values.rollNumber);
                            if (department)
                                    ...
                                    <Grid container spacing={2}>
                                        <Grid item xs={12} sm={6}>
                                            <FormControl fullWidth>
                                                ...
                                                />
                                                {
                                                    touched.firstName && <FormHelperText error={true}>{errors.firstName}</FormHelperText>
                                                }
                                            </FormControl>
                                        </Grid>
                                        <Grid item xs={12} sm={6}>
                                            <FormControl fullWidth>
                                                ...
                                                />
                                                {
                                                    touched.lastName && <FormHelperText error={true}>{errors.lastName}</FormHelperText>
                                                }
                                            </FormControl>
                                        </Grid>
                                        <Grid item xs={12}>
                                            <FormControl fullWidth>
                                                ...
                                                />
                                                {
                                                    touched.email && <FormHelperText error={true}>{errors.email}</FormHelperText>
                                                }
                                                {
                                                    this.state.emailExistsError && <FormHelperText error={true}>* This email already exists. Contact the admin in case of any problem.</FormHelperText>
                                                }
                                            </FormControl>
                                        </Grid>
                                        <Grid item xs={12}>
                                            <FormControl fullWidth>
                                                ...
                                                />
                                                {
                                                    touched.rollNumber && <FormHelperText error={true}>{errors.rollNumber}</FormHelperText>
                                                }
                                                {
                                                    this.state.rollNumberError && <FormHelperText error={true}>* This Roll Number already exists. Contact the admin in case of any problem.</FormHelperText>
                                                }
                                            </FormControl>
                                        </Grid>
                                        <Grid item xs={12} sm={5}>
                                            <FormControl fullWidth>
                                                ...
                                                />
                                                {
                                                    touched.year && <FormHelperText error={true}>{errors.year}</FormHelperText>
                                                }
                                            </FormControl>
                                        </Grid>
                                        ...
                                        <Grid item xs={12}>
                                            ...
                                            <RadioGroup aria-label="section" id="section" name="section" value={values.section} onChange={handleChange} onBlur={handleBlur} row>
                                                <FormControlLabel
                                                    value="a"
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <FormControl fullWidth>
                                                ...
                                                />
                                                {
                                                    touched.password && <FormHelperText error={true}>{errors.password}</FormHelperText>
                                                }
                                                {
                                                    <FormHelperText error={false}>{this.state.passwordMessage}</FormHelperText>
                                                }
                                            </FormControl>
                                        </Grid>
                                        <Grid item xs={12} sm={6}>
                                            <FormControl fullWidth>
                                                ...
                                                />
                                                {
                                                    touched.confirmPassword && <FormHelperText error={true}>{errors.confirmPassword}</FormHelperText>
                                                }
                                            </FormControl>
                                        </Grid>
                                        <Grid item xs={12}>
                                            <FormControlLabel
                                                control={<Checkbox value={values.acknowledged} color="primary" onChange={this.handleAckChange} />}
                                                label="I agree that aforementioned details are correct."
                                            />
                                            {
                                                <FormHelperText error={true}>{this.state.isAckChecked ? "" : this.state.ackMessage}</FormHelperText>
                                            }
                                        </Grid>
                                    </Grid>
                                    <Button
